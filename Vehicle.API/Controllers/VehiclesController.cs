...
namespace Vehicle.API.Controllers
{
    ...
    public class VehiclesController : ApiController
    {
        ...
        // GET: api/Vehicles
        public IQueryable<Models.Vehicle> GetVehicles()
        {
            return db.Vehicles;
        }

        // GET: api/Vehicles/5
        [ResponseType(typeof(Models.Vehicle))]
        ...
        public IHttpActionResult PutVehicle(int id, Models.Vehicle vehicle)
        {
        ...
        // POST: api/Vehicles
        [ResponseType(typeof(Models.Vehicle))]
        public IHttpActionResult PostVehicle(Models.Vehicle vehicle)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
